...
%         'CMU Serif','DefaultTextFontSize',5,'DefaultLegendFontname', ...
%         'CMU Serif','DefaultLegendFontSize',5,'defaultlegendinterpreter',...
%         'latex','defaultAxesTickLabelInterpreter','latex',...
%         'DefaultAxesTitleFontSizeMultiplier', 1,'DefaultAxesFontSize', 5,...
%         'DefaultLegendFontSizeMode','manual','DefaultTextFontSizeMode','manual');

%% width & hight of the figure
k_scaling = 3.5;          % scaling factor of the figure
