function dxdt = diff_olrt_gp(t,x,Xd1, Xd2, Xd3, ... %Yd1, Yd2,Yd3,...
    postF1,postF2,postF3)

    % We use a command filter for computing the time derivatives required
    % for the backstepping control law. For more details, see, e.g., 
    % A. Capone and S. Hirche, "Backstepping for Partially Unknown 
    % Nonlinear Systems Using Gaussian Processes," in IEEE Control Systems 
    % Letters, vol. 3, no. 2, pp. 416-421, April 2019.
